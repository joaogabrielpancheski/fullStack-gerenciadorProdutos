<%-- 
    Document   : produtos
    Created on : 22/10/2018, 22:02:54
    Author     : João Gabriel
--%>
    ...
    <body>
        <main class="container">
            ...
            <section>
                ...
                <form name="form-produto" enctype="multipart/form-data" accept-charset="utf-8" method="POST" onsubmit="return validaCadastro();">
                    <input type="hidden" name="produto-id" value="<%= produto.getId()%>" />
                    <div class="form-group">
                        <label for="produto-nome">Nome</label>
                        <input type="text" class="form-control" id="produto-nome" name="produto-nome" value="<%= produto.getNome()%>" />
                        <div class="invalid-feedback">Informe o nome com o mínimo de 5 caracteres.</div>
                    </div>
                    <div class="form-group">
                        <label for="produto-descricao">Descrição</label>
                        <textarea class="form-control" id="produto-descricao" name="produto-descricao"><%= produto.getDescricao()%></textarea>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-4">
                            <label for="produto-preco">Preço</label>
                            <input type="number" class="form-control" id="produto-preco" name="produto-preco" step="0.01" value="<%= produto.getPreco()%>">
                            <div class="invalid-feedback">Informe o preço do produto.</div>
                        </div>
                        <div class="form-group col-4">
                            <label for="produto-quantidade">Quantidade</label>
                            <input type="number" class="form-control" id="produto-quantidade" name="produto-quantidade" step="1" value="<%= produto.getQuantidade()%>">
                            <div class="invalid-feedback">Informe a quantidade do produto.</div>
                        </div>
                        <div class="form-group col-4">
                            <label for="produto-validade">Data de validade</label>
                            <input type="date" class="form-control" id="produto-validade" name="produto-validade" value="<%= produto.getDataValidadeString()%>">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm" role="group">
                                <a href="produtos?produto=<%= p.getId()%>" class="btn">Editar</a>
